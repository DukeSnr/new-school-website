...
// ─── CAMPUSES ────────────────────────────────────────────────────────────────
const CAMPUSES = [
  { name: "Northcliff Campus",   address: "Cnr Davidson & 13th Ave, Northcliff",        phone: "011 123 4567" },
  { name: "Midrand Campus",      address: "Blue Hills Estate, 5 Mopani Rd, Midrand",    phone: "011 234 5678" },
  { name: "Pretoria East Campus",address: "Garsfontein Rd, Pretoria East, 0057",        phone: "012 345 6789" },
];
...
const TopBar = ({ onSearchClick }) => (
  <div style={{
    ...
    <div style={{ display:"flex", alignItems:"center", gap:"1.5rem" }}>
      ...
      <span style={{ opacity:0.8 }}>info@yourschool.co.za</span>
    </div>
...
// ═══════════════════════════════════════════════════════════════════
const MainNav = ({ scrolled, onEnquireClick }) => {
  ...
  return (
    <nav style={{
      ...
      <div style={{
        ...
        {/* Enquire CTA */}
        <button onClick={onEnquireClick} className="desktop-nav" style={{
          background:C.primary, color:"#fff",
          padding:"0.65rem 1.4rem", borderRadius:"2px",
          border:"none", fontWeight:700,
          fontSize:"0.78rem", letterSpacing:"0.08em",
          textTransform:"uppercase", transition:"background 0.2s", whiteSpace:"nowrap", cursor:"pointer",
        }}
      ...
      {mobileOpen && (
        <div style={{
          ...
          <div style={{padding:"1rem 1.5rem"}}>
            <button onClick={onEnquireClick} style={{
...
const EnquiryForm = ({ isOpen, onClose }) => {
  ...
  const sendEmail = async () => {
    const templateParams = {
      to_email: 'info@yourschool.co.za', // Replace with actual email
    ...
    // Note: EmailJS setup required. Replace with your service ID, template ID, public key
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ color: C.primary, marginBottom: '1rem' }}>Enquire Now</h2>
...
// FOOTER
// ═══════════════════════════════════════════════════════════════════
const Footer = ({ onEnquireClick }) => (
  <footer style={{background:C.dark, color:"rgba(255,255,255,0.7)"}}>
    <div style={{maxWidth:"1600px", margin:"0 auto", padding:"4rem 2rem 2rem"}}>
      <div style={{
        display:"grid",
        ...
        <div>
          ...
          {["About Us","Our Campuses","Curriculum","Open Days","Careers"].map(l=>(
            <a key={l} href="#" style={{
          ...
          <button onClick={onEnquireClick} style={{
            ...
            marginBottom:"0.6rem", transition:"color 0.2s", cursor:"pointer",
  ...
  return (
    <div style={{fontFamily:"'Source Serif 4', Georgia, serif", background:C.white}}>
      ...
      <div className="sticky-header">
        ...
        <MainNav scrolled={scrolled} onEnquireClick={() => setEnquiryOpen(true)} />
      </div>

      {/* PAGE CONTENT */}
      <HeroSlider onEnquireClick={() => setEnquiryOpen(true)} />
      <AboutSection />
      <VideoSection />
      <OpenDaysSection />
      <QuoteSection />
      <FeaturesCarousel />
      <PartnershipSection />
      <Footer onEnquireClick={() => setEnquiryOpen(true)} />
